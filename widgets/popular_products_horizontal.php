<?php
class Ceneo_Plugin_Popular_Products_Horizontal extends WP_Widget {
  ...
  function Ceneo_Plugin_Popular_Products_Horizontal() {
     /* Widget settings. */
    $widget_ops = array(
      'classname' => 'ceneoplugpopprodhoriz',
      'description' => 'Pozwalana na dodanie poziomego widgetu z produktami Ceneo.');

     /* Widget control settings. */
    $control_ops = array(
       'width' => 300,
       'height' => 250,
       'id_base' => 'ceneoplugpopprodhoriz-widget');

    /* Create the widget. */
   $this->WP_Widget('ceneoplugpopprodhoriz-widget', 'Produkty Ceneo Poziomo', $widget_ops, $control_ops );
  ...
  function form ($instance) {
   ...
   <p>
   		...
   		<input type="text" name="<?php echo $this->get_field_name('product_ids') ?>" id="<?php echo $this->get_field_id('product_ids') ?> " value="<?php echo $instance['product_ids'] ?>" size="30">
   </p>
   <p>
...
function widget ($args,$instance) {
  ...
  $out .= '</h3>';
	...
	$out .= '<div class="ceneo-horizontal-plugin clearfix">';
	$out .= '<div class="scrolledContent">';
